...
const QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "otro_america", label: "Otro país de América", hasText: true },
    ],
  },
  {
    id: "p10",
  ...
  },
  {
    id: "p35",
    dim: 4,
    text: "¿Qué factor ha sido clave para que continúe estudiando? Indica el nivel de importancia de cada uno.",
    type: "likert",
    likertScale: [
    ...
    items: [
      { id: "p35_apoyo_familiar",        label: "Apoyo familiar" },
      { id: "p35_motivacion_personal",   label: "Motivación personal" },
      { id: "p35_superacion_personal",   label: "Deseo de superación personal" },
      { id: "p35_metas_vida",            label: "Cumplimiento de metas y proyectos de vida" },
      { id: "p35_capacidad_financiera",  label: "Capacidad financiera/económica" },
      { id: "p35_oportunidades",         label: "Mejores oportunidades laborales" },
      { id: "p35_crecimiento",           label: "Crecimiento profesional" },
      { id: "p35_apoyo_institucional",   label: "Apoyo institucional" },
      { id: "p35_subsidios",             label: "Subsidios de matrícula" },
      { id: "p35_becas",                 label: "Becas de estudio" },
      { id: "p35_flexibilidad",          label: "Flexibilidad de la modalidad" },
      { id: "p35_tutorias",              label: "Apoyos tutoriales sincrónicos" },
      { id: "p35_trabajo_colaborativo",  label: "Trabajo colaborativo" },
      { id: "p35_pautas_estudio",        label: "Pautas de estudio proporcionadas por los docentes" },
    ],
  },
];
